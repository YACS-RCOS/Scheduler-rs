...
fn solve_rec<'lifetime>(schedules: &'lifetime [ScheduleList], current: Vec<InfoScheduleOption<'lifetime>>)
        ...
        1 => {
            ...
            */
            schedules.last()
                ...
                .label_options()
                .iter()
                .filter(|schedule_option| !current.iter()
                    .any(|currently_selected_schedule_option|
